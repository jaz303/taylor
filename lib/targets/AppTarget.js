...
AppTarget.prototype.generateMakefile = function(makefile) {
    ...
    // This is a top-level target to build the entire app
    ...
    // TODO: need to be able to pass the following to the method:
    //  - library import path
    ...
    generateModuleTarget(makefile, {
        name            : this.id + '_main',
        umbrellaTarget  : this.id + '_main',
        libraryDir      : 'build/lib',
